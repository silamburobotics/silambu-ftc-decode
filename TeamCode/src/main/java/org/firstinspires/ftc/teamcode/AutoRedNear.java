...
public class AutoRedNear extends LinearOpMode {
    ...
    private static final String POSITION = "NEAR";
    private static final Pose2d START_POSE = new Pose2d(-12.0, -132.0, Math.toRadians(180)); // Red alliance starting pose (opposite side from Blue)
    ...
    public void runOpMode() {
        ...
        telemetry.addData("3.", "Move reverse 12 inches using Road Runner");
        telemetry.addData("", "");
    ...
    private void executeAutonomousSequence() {
        ...
        Action moveLeft = drive.actionBuilder(new Pose2d(START_POSE.position.x - REARWARD_DISTANCE, START_POSE.position.y, START_POSE.heading.toDouble()))
                .strafeToLinearHeading(new Vector2d(START_POSE.position.x - REARWARD_DISTANCE, START_POSE.position.y - LEFTWARD_DISTANCE), START_POSE.heading.toDouble())  // Strafe reverse 12 inches (perpendicular to first movement)
                .build();
        ...
        // Step 3: Move reverse 12 inches
        telemetry.addData("🚀 STEP 3", "Moving reverse %.1f inches...", LEFTWARD_DISTANCE);
        telemetry.update();
        Actions.runBlocking(moveLeft);
        
        telemetry.addData("✅ AUTONOMOUS", "Red Near Road Runner sequence completed!");
        telemetry.addData("🔴 Alliance", "RED");
        telemetry.addData("📍 Final Position", "50\" left + 12\" reverse from start");
