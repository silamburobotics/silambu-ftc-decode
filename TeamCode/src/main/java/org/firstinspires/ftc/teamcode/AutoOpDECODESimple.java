...
public class AutoOpDECODESimple extends LinearOpMode {
    ...
    public static double SHOOTER_TARGET_VELOCITY = 1250;      // Range: 1200-1800 ticks/sec
    ...
    public void runOpMode() {
        ...
        telemetry.addData("Total Time", "~10-15 seconds");
        telemetry.addData("", "");
        telemetry.addData("Mode", "Shooting Only (No Movement)");
